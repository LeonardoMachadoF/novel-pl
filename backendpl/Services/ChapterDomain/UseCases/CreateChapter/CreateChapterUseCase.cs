...
public class CreateChapterUseCase : ICreateChapterUseCase
{
    ...
    public CreateChapterUseCase(IChapterRepository chapterRepository,
        IValidationBehavior<CreateChapterDto> validationBehavior, IGetNovelUseCase getNovelUseCase)
    {
